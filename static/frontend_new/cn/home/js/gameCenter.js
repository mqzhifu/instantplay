...
$(document).ready(function() {
	...
	if(type=='h5'){
		...
		$(".codeBg img,.scan img,.downBox img").attr("src","#HTTP_PROTOCOL#://#STATIC_URL#/frontend_new/home/img/qrH5Code.png");
	}else{
		//$(".codeBg img,.scan img").attr("src"," //mgres.kaixin001.com.cn/xyx/static/frondend/home/img/qrCode.png");
		$(".codeBg img,.scan img,.downBox img").attr("src","#HTTP_PROTOCOL#://#STATIC_URL#/frontend_new/home/img/qrCode.png");
	}
});
...
function downLoad() {
	...
	if(isiOS==true){
		...
		if(type=='h5'){
			window.open(" //mgres.kaixin001.com.cn/xyx/static/downLoad/android/toptcad/topeffects_wz_h5.apk");
		}else{
			window.open(" //mgres.kaixin001.com.cn/xyx/static/downLoad/android/toptcad/topeffects_wz.apk");
		}
