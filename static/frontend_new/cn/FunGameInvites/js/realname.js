(function(window) {
	var R = window.R = {
		shoujiyanzheng: "#HTTP_PROTOCOL#://#API_URL#/userSafe/bindcellphone/cellphone=",
		shenfenxinxi: "#HTTP_PROTOCOL#://#API_URL#/userSafe/addReadIdAuth/",
		fasongduanxin:"#HTTP_PROTOCOL#://#API_URL#/system/sendSMS/cellphone=",
		yonghuxinxi:"#HTTP_PROTOCOL#://#API_URL#/user/getOne/toUid=&token=",
		qushenfenjiaoyan:"#HTTP_PROTOCOL#://#API_URL#/userSafe/isReadIdAuth/token=",
